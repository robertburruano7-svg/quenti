...
import { BODY_COPY_SEO } from "@studyapp/branding";
...
import {
  ...
  buildEntityImage,
  buildProfileImage,
} from "@studyapp/lib/seo";
import { truncateOnWord } from "@studyapp/lib/text";
import { canonicalUrl } from "@studyapp/lib/url";
...
export const HeadSeo: React.FC<HeadSeoProps> = ({
  ...
  const title = `${_title}${!hideTitleSuffix ? " | Studyapp" : ""}`;
